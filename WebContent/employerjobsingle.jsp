         ...
         <!-- start single archive post -->
          <div class="single_archiveblog">
            <div class="archiveblog_left">
              ...
              <h5 class="author_name">${job.employer.name}</h5>
            </div>
            ...
            <div class="archiveblog_right">
              ...
              <p>Contact: ${job.employer.emailAddress}</p>
              <p>Company Description: ${job.employer.description}</p>
               <form action="doGetEmployerJobEditView.htm" method="post">
              <input type="hidden" name="jobId" value="${job.id}">
              <input class="wpcf7-submit photo-submit" type="submit" value="Edit">
              </form>
              <form action="doGetCandidates.htm" method="post">
              <input type="hidden" name="jobId" value="${job.id}">
              <input class="wpcf7-submit photo-submit" type="submit" value="Candidates">
              </form>
            </div>
          </div>
