			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="contact_area">
					<div class="client_title">
						<hr>
						<h2>
							Search <span>Job By Title</span>
						</h2>
					</div>
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="contact_left wow fadeInLeft">
								<form class="submitphoto_form" action="doSearchJob.htm" method="POST">
									<input type="text" name="title" class="form-control wpcf7-text"
										placeholder="Job Title"> <input type="submit"
										value="Search" class="wpcf7-submit photo-submit">
								</form>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="contact_right wow fadeInRight">
								<img src="../img/job_icon.png" alt="img" style="height:300px; width: 400px ">
							</div>
						</div>
					</div>
				</div>
