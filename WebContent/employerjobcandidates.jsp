      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="client_title">
            <hr>
            <h2>Candidates <span>Applied</span></h2>
            </div>
          </div>
          <!-- Start Plan area -->
          <div class="pricearea">
            ...
            <c:forEach items="${profiles}" var="profile">              
              <li>
                <h2 class="price_heading">${profile.name}</h2>
               <ul class="pfeatured_nav">
                  <li><strong> Position: </strong> ${profile.currentPosition} </li>
                  <li><strong> Location: </strong> ${profile.location} </li>
                  <li>${profile.emailAddress}</li>
                </ul>
                <a class="get_button" href="doGetCandidateProfile.htm?jobSeekerId=${profile.id}">Get Details</a>
              </li>
              <!-- Start single Plan -->
             </c:forEach>
            </ul>
