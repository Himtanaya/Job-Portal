				...
				<div class="blogArchive_area">
					...
					<div class="single_archiveblog">
						...
						<div class="archiveblog_right">
							...
							<ul>
								<li>Current Position: ${profile.currentPosition}</li>
							</ul>
							...
							<ul>
								...
								<h3>Experience:</h3>
							<ul>
								<c:forEach items="${profile.experience}" var="experience">
									<li>${experience}</li>
								</c:forEach>
							</ul>
								...
								<h3>Projects:</h3>
							<ul>
								<c:forEach items="${profile.projects}" var="project">
									<li>${project}</li>
								</c:forEach>
							</ul>

							<p>Contact: ${profile.emailAddress}</p>
							 <form action="../email/doGetEmployerEmailView.htm" method="post">
            				 <input type="hidden" name="email" value="${profile.emailAddress}">
             				 <input class="wpcf7-submit photo-submit" type="submit" value="Revert">
              				 </form>
						</div>
					</div>
								...
								<li>
									<div class="media">
										<div class="media-body">
											<h4 class="media-heading">${interest}</h4>
										</div>
									</div>
								</li>
							</c:forEach>
						...
						<ul class="small_catg similar_nav">
							<c:forEach items="${profile.skills}" var="skill">
								<li>
									<div class="media">
										<div class="media-body">
											<h4 class="media-heading">${skill}</h4>
										</div>
									</div>
								</li>
							</c:forEach>
