...
<body>
	...
	<div class="container">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="contact_left wow fadeInLeft">
								<form class="submitphoto_form" action="doLogin.htm" method="POST">
									Username: <input type="text" name="username"
										class="form-control wpcf7-text" placeholder="username">
									Password: <input type="password" name="password"
										class="form-control wpcf7-text" placeholder="password">
									<input type="submit" value="Login"
										class="wpcf7-submit photo-submit">
								</form>
		...
		<script src="../js/jquery.superslides.min.js" type="text/javascript"
